...
function populateParameters(result) {var _result$brand =
  ...
  var parameters = {
    appId: "__UNI__7B89F9E",
    appName: "xiaoluschool_uni",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"xiaoluschool_uni","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
